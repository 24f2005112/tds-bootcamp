...
--- Before Day-1 ---
I already knew : I was already familiar with Linux system commands and basic terminal usage before Day-1. I knew how to navigate directories, create files and folders, use command-line tools, and work with file paths. I had also used GitHub previously and was comfortable with basic development workflows.
--- 
...
The importance of using the terminal efficiently instead of relying only on graphical interfaces.
---

--- Feedback (Suggestions for the TDS Team) ---
This is my feedback : The session was well-structured and beginner-friendly.
---

---
---

You can write your personal notes here; Nothing yet.
